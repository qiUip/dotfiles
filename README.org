...
The dotfiles here could be soft-linked into '/\slash{}home\slash{}<username>\slash{}.config/'.  I use them more as tamplets as I have several machines with specific settings so I use these more as tampletes.
...
Files in the scripts directory are soft linked to '/\slash{}ome\slash{}<username>\slash{}.scripts/' 
