...
The config files here could be soft-linked into '/\slash{}home\slash{}<username>\slash{}.config/'.  I use them more as tamplets as I have several machines with specific settings.
